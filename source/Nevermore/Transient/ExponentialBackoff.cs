...
namespace Nevermore.Transient
{
    ...
    public class ExponentialBackoff : RetryStrategy
    {
        ...
        readonly TimeSpan _deltaBackoff;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:Nevermore.Transient.ExponentialBackoff" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Nevermore.Transient.ExponentialBackoff" /> class with the specified retry settings.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Nevermore.Transient.ExponentialBackoff" /> class with the specified name and retry settings.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Nevermore.Transient.ExponentialBackoff" /> class with the specified name, retry settings, and fast retry option.
        /// </summary>
        /// <param name="name">The name of the retry strategy.</param>
        /// <param name="retryCount">The maximum number of retry attempts.</param>
        /// <param name="minBackoff">The minimum backoff time</param>
        ...
        public override ShouldRetry GetShouldRetry()
        {
            return delegate(int currentRetryCount, Exception lastException, out TimeSpan retryInterval)
            {
                if (currentRetryCount < this._retryCount)
                {
                    ...
                    var num = (int) ((Math.Pow(2.0, currentRetryCount) - 1.0)*(double) random.Next((int) (this._deltaBackoff.TotalMilliseconds*0.8), (int) (this._deltaBackoff.TotalMilliseconds*1.2)));
                    var num2 = (int) Math.Min(this._minBackoff.TotalMilliseconds + num, this._maxBackoff.TotalMilliseconds);
