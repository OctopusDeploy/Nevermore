...
namespace Nevermore.Transient
{
    ...
    public class Incremental : RetryStrategy
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Nevermore.Transient.Incremental" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Nevermore.Transient.Incremental" /> class with the specified retry settings.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Nevermore.Transient.Incremental" /> class with the specified name and retry settings.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Nevermore.Transient.Incremental" /> class with the specified number of retry attempts, time interval, retry strategy, and fast start option.
        /// </summary>
        /// <param name="name">The retry strategy name.</param>
        /// <param name="retryCount">The number of retry attempts.</param>
        /// <param name="initialInterval">The initial interval that will apply for the first retry.</param>
