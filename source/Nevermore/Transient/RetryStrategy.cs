...
namespace Nevermore.Transient
{
    ...
    public abstract class RetryStrategy
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Nevermore.Transient.RetryStrategy" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Returns a default policy that implements a fixed retry interval configured with the <see cref="F:Nevermore.Transient.RetryStrategy.DefaultClientRetryCount" /> and
        /// <see cref="F:Nevermore.Transient.RetryStrategy.DefaultRetryInterval" /> parameters.
        ...
        /// <summary>
        /// Returns a default policy that implements a progressive retry interval configured with the <see cref="F:Nevermore.Transient.RetryStrategy.DefaultClientRetryCount" />,
        /// <see cref="F:Nevermore.Transient.RetryStrategy.DefaultRetryInterval" />, and <see cref="F:Nevermore.Transient.RetryStrategy.DefaultRetryIncrement" /> parameters.
        /// The default retry policy treats all caught exceptions as transient errors.
        /// </summary>
        ...
        /// <summary>
        /// Returns a default policy that implements a random exponential retry interval configured with the <see cref="F:Nevermore.Transient.RetryStrategy.DefaultClientRetryCount" />,
        /// <see cref="F:Nevermore.Transient.RetryStrategy.DefaultMinBackoff" />, <see cref="F:Nevermore.Transient.RetryStrategy.DefaultMaxBackoff" />, and
        /// <see cref="F:Nevermore.Transient.RetryStrategy.DefaultClientBackoff" /> parameters.
        /// The default retry policy treats all caught exceptions as transient errors.
        /// </summary>
