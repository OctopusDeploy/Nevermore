...
namespace Nevermore
{
    public interface IWriteQueryExecutor : IReadQueryExecutor
    {
        ...
        /// If the mapping specifies a SingletonId, that is returned
        /// </summary>
        /// <typeparam name="TDocument">The type of document to allocate the id for. Used to find the table against which the id will be allocated against.</typeparam>
        /// <returns>The new id</returns>
        string AllocateId<TDocument>() where TDocument : class;
        ...
        /// <param name="cancellationToken">Token to use to cancel the command.</param>
        /// <returns></returns>
        Task<string> AllocateIdAsync(Type documentType, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Token to use to cancel the command.</param>
        /// <returns></returns>
        Task<string> AllocateIdAsync<TDocument>(CancellationToken cancellationToken = default) where TDocument : class;
        ...
        /// <param name="cancellationToken">Token to use to cancel the command.</param>
        /// <returns></returns>
        Task<string> AllocateIdAsync(string tableName, string idPrefix, CancellationToken cancellationToken = default);
    }
}