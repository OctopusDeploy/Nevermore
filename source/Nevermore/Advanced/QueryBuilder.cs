...
namespace Nevermore.Advanced
{
    public class QueryBuilder<TRecord, TSelectBuilder> : IOrderedQueryBuilder<TRecord> where TSelectBuilder: ISelectBuilder where TRecord : class
    {
        ...
        {
            return new QueryBuilder<TNewRecord, TSelectBuilder>(selectBuilder, readQueryExecutor, cacheTableColumnsBuilder, tableAliasGenerator, uniqueParameterNameGenerator, ParameterValues, Parameters, ParameterDefaults);
        }
